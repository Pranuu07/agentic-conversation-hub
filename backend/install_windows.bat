...
python -m pip install pydantic==2.4.2 --trusted-host pypi.org --trusted-host files.pythonhosted.org
...
echo Installing LangChain (this may take a while)...
...
python -m pip install chromadb==0.4.15 --trusted-host pypi.org --trusted-host files.pythonhosted.org
